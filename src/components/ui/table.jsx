...
export function TableHead({ className, ...props }) { return <th className={cn("h-11 px-4 text-xs font-extrabold uppercase tracking-[0.08em] text-ink-muted", className)} {...props} />; }
export function TableCell({ className, ...props }) { return <td className={cn("px-4 py-4 align-top text-sm", className)} {...props} />; }
