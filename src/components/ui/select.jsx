...
export function SelectItem({ className, children, ...props }) {
  return (
    <SelectPrimitive.Item
      className={cn(
        "relative flex h-10 cursor-default select-none items-center rounded-[6px] py-2 pl-8 pr-3 text-[13px] font-semibold outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-selected data-[disabled]:opacity-40",
        className
      )}
      {...props}
    >
